...
public class CoordinateCalculateUtil {
     ...
     */
    public static double[] evaluateCoordinates(BigDecimal xa, BigDecimal ya, BigDecimal xb, BigDecimal yb, BigDecimal xc, BigDecimal yc, BigDecimal ra, BigDecimal rb, BigDecimal rc){
        ...
        point[0] = x.doubleValue();
        point[1] = y.doubleValue();
        return point;
    }
    ...
    public static double[] trilateration(double x1,double y1,double d1, double x2, double y2,double d2, double x3, double y3, double d3)
    {
        ...
        double[] point = new double[2];
        point[0]=(b1*a22-a12*b2)/(a11*a22-a12*a21);
        point[1]=(a11*b2-b1*a21)/(a11*a22-a12*a21);
        return point;
    }
}
