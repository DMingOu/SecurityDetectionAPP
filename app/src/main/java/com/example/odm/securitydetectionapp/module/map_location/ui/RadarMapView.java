...
//        point_y = UtilTools.Getrandomarray(15, 300);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(viewSize / 2, viewSize / 2, 455, mPaintCircle);
        canvas.drawCircle(viewSize / 2, viewSize / 2, 570, mPaintCircle);
//        canvas.drawCircle(viewSize / 2, viewSize / 2, 760, mPaintCircle);
        //绘制两条十字线
...
//        }
        ...
        canvas.drawCircle(viewSize / 2, viewSize / 2, 570, mPaintSector);
        super.onDraw(canvas);
    }
    ...
    /**
     *The type Scan thread. 执行旋转动画的线程
     */
    protected class ScanThread extends Thread {

        private RadarMapView view;

        public ScanThread(RadarMapView view) {
            // TODO Auto-generated constructor stub
            this.view = view;
        }
